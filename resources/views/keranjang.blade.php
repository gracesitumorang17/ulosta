...
<body class="bg-gray-50 text-gray-800 antialiased">
    ...
    <script>
            ...
            modal.innerHTML = `
                <div class="bg-white rounded-2xl p-6 max-w-sm mx-4 shadow-2xl transform transition-all">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">Hapus dari Keranjang?</h3>
                        <p class="text-sm text-gray-500 mb-6">Produk ini akan dihapus dari keranjang Anda.</p>
                        <div class="flex gap-3">
                            ...
                            <button onclick="confirmDeleteCart(${itemId}, this)" class="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-medium">
                                Hapus
                            </button>
                        </div>
                    </div>
        ...
        function confirmDeleteCart(itemId, button) {
