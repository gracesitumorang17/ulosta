        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <a href="{{ route('wishlist.index') }}"
                        class="relative flex items-center gap-2 text-gray-800 hover:text-red-600 transition">
                        <div class="relative">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div id="profile-menu"
                            ...
                            <nav class="py-2">
                                ...
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="w-full text-left flex items-center gap-3 px-4 py-3 text-gray-800 hover:bg-gray-50 transition">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-600"
                                            fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                            stroke-width="1.5">
                                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div id="mobile-search" class="md:hidden pb-3">
                <form action="{{ route('homepage') }}" method="GET">
                    <div class="relative">
                        <input name="q" type="search" value="{{ $search ?? '' }}" placeholder="Cari ulos..."
            ...
            <div id="mobile-menu" class="md:hidden hidden pb-4">
                <nav class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                    ...
                    <a href="{{ route('wishlist.index') }}"
                        class="relative flex items-center gap-3 px-4 py-3 text-gray-800 hover:bg-gray-50">
                        <div class="relative">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <section id="categories" class="py-16">
            <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition group relative overflow-hidden"
                        data-aos="fade-right">
                        <div class="relative">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition group relative overflow-hidden"
                        ...
                        <div class="relative">
                            <div class="mb-4 rounded-xl overflow-hidden relative">
                                <div class="ratio-3-2">
                                    <img src="{{ asset('image/fungsiulos.jpg') }}" alt="Fungsi Ulos"
                                        class="absolute inset-0 w-full h-full object-cover" />
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/50 via-black/10 to-transparent">
                                    </div>
            ...
            <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-500 mt-2" data-aos="fade-up" data-aos-delay="60">
                        @if ($search ?? false)
                            Hasil pencarian untuk: <span
                                class="font-semibold text-red-600">"{{ $search }}"</span>
                            @if (count($products) > 0)
                ...
                <!-- Filter Section -->
                <form id="filter-form" method="GET" action="{{ route('homepage') }}"
                    class="flex flex-wrap items-center justify-center gap-6 mb-8" data-aos="fade-up"
                    data-aos-delay="100">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative">
                            <select name="jenis" id="jenis-filter"
                                ...
                                class="appearance-none bg-white border border-gray-300 rounded-lg px-4 py-2 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-red-600 cursor-pointer">
                                <option value="">Semua Jenis</option>
                                <option value="Ragidup" {{ ($jenisFilter ?? '') == 'Ragidup' ? 'selected' : '' }}>Ulos
                                    Ragidup</option>
                                <option value="Ragi Hotang"
                                    {{ ($jenisFilter ?? '') == 'Ragi Hotang' ? 'selected' : '' }}>Ulos Ragi Hotang
                                </option>
                                <option value="Sibolang" {{ ($jenisFilter ?? '') == 'Sibolang' ? 'selected' : '' }}>
                                    Ulos Sibolang</option>
                                <option value="Bintang Maratur"
                                    {{ ($jenisFilter ?? '') == 'Bintang Maratur' ? 'selected' : '' }}>Ulos Bintang
                                    Maratur</option>
                                <option value="Sadum" {{ ($jenisFilter ?? '') == 'Sadum' ? 'selected' : '' }}>Ulos
                                    Sadum</option>
                                <option value="Mangiring" {{ ($jenisFilter ?? '') == 'Mangiring' ? 'selected' : '' }}>
                                    Ulos Mangiring</option>
                            </select>
                            <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative">
                            <select name="fungsi" id="fungsi-filter"
                                onchange="document.getElementById('filter-form').submit()"
                                class="appearance-none bg-white border border-gray-300 rounded-lg px-4 py-2 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-red-600 cursor-pointer">
                                <option value="">Semua Fungsi</option>
                                <option value="Pernikahan"
                                    {{ ($fungsiFilter ?? '') == 'Pernikahan' ? 'selected' : '' }}>Pernikahan</option>
                                <option value="Kelahiran"
                                    {{ ($fungsiFilter ?? '') == 'Kelahiran' ? 'selected' : '' }}>Kelahiran</option>
                                <option value="Kematian" {{ ($fungsiFilter ?? '') == 'Kematian' ? 'selected' : '' }}>
                                    Kematian</option>
                                <option value="Syukuran" {{ ($fungsiFilter ?? '') == 'Syukuran' ? 'selected' : '' }}>
                                    Syukuran</option>
                                <option value="Serbaguna"
                                    {{ ($fungsiFilter ?? '') == 'Serbaguna' ? 'selected' : '' }}>Serbaguna</option>
                            </select>
                            <div
                                class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                                <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                    ...
                    @if (($jenisFilter ?? false) || ($fungsiFilter ?? false))
                        <a href="{{ route('homepage') }}{{ $search ?? false ? '?q=' . $search : '' }}"
                ...
                @if (count($products) > 0)
                    <div id="product-grid"
                        class="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 items-stretch">
                            ...
                            <article
                                ...
                                <div class="relative">
                                    <a href="{{ route('produk.detail', $p['id']) }}" class="block">
                                        <div class="aspect-[4/3] relative">
                                            <img src="{{ $p['image_url'] ?? ($p['image'] ? asset('storage/' . ltrim($p['image'], '/')) : asset('image/placeholder.png')) }}"
                                                alt="{{ $p['name'] }}"
                                                class="absolute inset-0 w-full h-full object-cover" />
                                        </div>
                                    </a>
                                    ...
                                    <div class="absolute left-3 top-3">
                                        <span
                                            class="bg-red-600 text-white text-xs font-semibold px-3 py-1 rounded">Terlaris</span>
                                    </div>
                                    ...
                                    <div class="absolute right-3 top-3">
                                        <button
                                            ...
                                            data-product-id="{{ $index }}" aria-label="Tambah ke wishlist">
                                ...
                                <div class="p-4 flex-1 flex flex-col">
                                    ...
                                    @if (!empty($p['category']))
                                        <div class="mb-2">
                                            <span
                                                class="inline-block bg-yellow-100 text-gray-800 text-xs font-semibold px-3 py-1.5 rounded">{{ $p['category'] }}</span>
                                        </div>
                                    @endif
                                    <!-- Title & desc -->
                                    ...
                                    <div class="mt-auto grid grid-cols-2 gap-3">
                                        ...
                                        <a href="{{ route('produk.detail', $p['id']) }}"
                                            class="inline-flex items-center justify-center gap-1 px-4 border border-red-700 text-red-700 rounded-lg hover:bg-red-50 h-11 text-sm font-medium">
                ...
                @else
                    ...
                    <div class="mt-12 text-center py-16">
                        ...
                        <p class="text-gray-500 mb-6">Maaf, tidak ada produk yang cocok dengan pencarian
                            "{{ $search }}"</p>
                        <a href="{{ route('homepage') }}"
                            class="inline-flex items-center gap-2 bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition font-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
