            ...
            <nav class="nav-links">
                <a href="/" class="nav-link">
                    <svg class="nav-icon" viewBox="0 0 24 24" fill="none">
                        <path d="M3 9l9-7 9 7v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" stroke="currentColor" stroke-width="2"/>
    ...
    <div class="container">
        ...
        <div class="product-section">
            ...
            <div class="product-images">
                ...
                <img id="mainImage" class="main-image" src="{{ $product['images'][0] ?? asset('image/ulos1.jpeg') }}" alt="Ulos Ragihotang Premium">
            ...
            <div class="product-info">
                ...
                <div class="product-price">
                    <span class="current-price">Rp {{ number_format($product['price'] ?? 1250000, 0, ',', '.') }}</span>
                    <span class="original-price">Rp {{ number_format($product['original_price'] ?? 1500000, 0, ',', '.') }}</span>
                ...
                <div class="quantity-section">
                    ...
                    <div class="quantity-controls">
                        ...
                        <input type="number" id="quantity" class="qty-input" value="1" min="1" max="15">
        ...
        <section class="recommendations">
            ...
            <div class="product-grid">
                @foreach(($recommendations ?? [
                    ['title'=>'Ulos Bintang Maratur','price'=>750000,'old'=>900000,'img'=>asset('image/ulos4.jpg'),'tag'=>'Kelahiran'],
                    ['title'=>'Ulos Ragi Idup','price'=>860000,'old'=>990000,'img'=>asset('image/ulos5.webp'),'tag'=>'Pernikahan'], 
                    ['title'=>'Ulos Bintang Maratur','price'=>750000,'old'=>900000,'img'=>asset('image/ulos2.jpg'),'tag'=>'Kelahiran']
                ]) as $rec)
                <div class="product-card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-price">
                            <span class="card-current-price">Rp {{ number_format($rec['price'], 0, ',', '.') }}</span>
                            <span class="card-original-price">Rp {{ number_format($rec['old'], 0, ',', '.') }}</span>
                        </div>
