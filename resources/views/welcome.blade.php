    ...
    <main>
        ...
        <div class="mt-6">
            <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
                <span class="inline-block bg-amber-100 text-amber-1000 px-4 py-1 rounded-full text-sm">Kategori
                    Pilihan</span>
            </div>
        </div>
        ...
        <section id="categories" class="py-16">
            <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                ...
                <p class="text-center text-gray-500 mt-2 mb-8" data-aos="fade-up" data-aos-delay="80">Jelajahi
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition group relative overflow-hidden"
                        ...
                        <div class="relative">
                            ...
                            <div class="mt-4">
                                <a href="#" class="text-red-600 font-medium group-hover:underline">Lihat semua
                                    jenis</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition group relative overflow-hidden"
                        ...
                        <div class="relative">
                            ...
                            <div class="mt-4">
                                <a href="#" class="text-red-600 font-medium group-hover:underline">Jelajahi
                                    fungsi ulos</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="p-4 flex-1 flex flex-col">
                                ...
                                <div class="mt-3 flex items-end justify-between">
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-400 line-through mt-0.5">{{ $p['original'] }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-auto">
                                    <a href="{{ route('tambah.ke.keranjang') }}" data-name="{{ $p['name'] }}"
                                        data-price="{{ $p['price'] }}" role="button"
