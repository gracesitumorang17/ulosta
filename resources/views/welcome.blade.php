                ...
                <div class="flex-1 hidden md:flex justify-center px-4 max-w-2xl">
                    <form action="#" method="GET" class="w-full">
                        <div class="relative">
                            ...
                            <button type="submit"
                                class="absolute right-1 top-1/2 -translate-y-1/2 bg-red-600 text-white px-4 py-1.5 rounded-full hover:bg-red-700 transition">
                                Cari
                            </button>
                        </div>
                    </form>
                ...
                <div class="flex items-center gap-4">
                    @auth
                        ...
                        <a href="#" class="relative p-2 rounded-full hover:bg-gray-100 transition">
                            ...
                            <!-- Cart badge -->
                            <span
                                class="absolute -top-1 -right-1 bg-red-600 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-semibold">3</span>
                        </a>
                        ...
                        <a href="#" class="relative p-2 rounded-full hover:bg-gray-100 transition">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-700" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M15 17h5l-1.4-1.4A6.5 6.5 0 0117 10V8a5 5 0 00-10 0v2c0 2-.8 3.9-2.4 5.4L3 17h5m7 0v1a3 3 0 11-6 0v-1m6 0H9" />
                            </svg>
                            <!-- Notification badge -->
                            <span
                                class="absolute -top-1 -right-1 bg-red-600 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-semibold">5</span>
                        </a>

                        <!-- User Profile Dropdown -->
                        <div class="dropdown">
                            <button class="flex items-center gap-2 p-1 rounded-full hover:bg-gray-100 transition">
                                <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name ?? 'User' }}&background=AE0808&color=fff"
                            ...
                            <div class="dropdown-menu">
                                <div class="py-2">
                                    <div class="px-4 py-2 border-b border-gray-100">
                                        <p class="text-sm font-semibold text-gray-800">{{ Auth::user()->name ?? 'User' }}
                                        </p>
                                    ...
                                    @if (Auth::user()->role ?? '' === 'admin')
                                        <a href="{{ route('admin.dashboard') }}"
                                            class="block px-4 py-2 text-sm text-red-600 hover:bg-red-50 transition font-medium">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline mr-2"
                                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 00-2-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v4m-6 0a2 2 0 002 2h2a2 2 0 00-2-2m0 0V9a2 2 0 012-2h2a2 2 0 012 2v4" />
                                            </svg>
                                            Admin Panel
                                        </a>
                                    ...
                                    <a href="#"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition">Profil
                                        Saya</a>
                                    <a href="#"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition">Pesanan
                                        Saya</a>
                                    <a href="#"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition">Wishlist</a>
                                    <div class="border-t border-gray-100 mt-2 pt-2">
                                        <form action="{{ route('logout') }}" method="POST">
                                            @csrf
                                            <button type="submit"
                                                class="w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-red-50 transition">Keluar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="absolute inset-0 flex items-center">
                                    <div class="pl-6 md:pl-10 lg:pl-12 max-w-2xl text-white text-left"
                                        ...
                                        <div class="mt-4 flex flex-wrap gap-3">
                                            <a href="#products"
                                                class="inline-flex items-center bg-red-600 text-white px-5 py-2 rounded-full shadow hover:bg-red-700 transition">Belanja
                                                Sekarang</a>
                                            <a href="#categories"
                                                class="inline-flex items-center border border-white/50 text-white px-5 py-2 rounded-full hover:bg-white/10 transition">Pelajari
                                                Lebih Lanjut</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                ...
                <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 items-stretch">
                    ...
                    @forelse($products as $index => $product)
                        <article
                            class="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition group h-full flex flex-col"
                            data-aos="fade-up" data-aos-delay="{{ 40 * ($index + 1) }}">
                            <a href="{{ route('produk.detail', $product['id']) }}" class="block">
                                <div class="relative">
                                    <div class="ratio-3-2">
                                        <img src="{{ $product['image_url'] ?? ($product['image'] ? asset('storage/' . ltrim($product['image'], '/')) : asset('image/placeholder.png')) }}"
                                    ...
                                    <button
                                        ...
                                        aria-label="Simpan favorit" onclick="toggleWishlist(event, this)"
                                ...
                                <div class="p-4 flex-1 flex flex-col">
                                    ...
                                    @if (!empty($product['category']))
                                        <div class="mb-2">
                                            <span
                                                class="inline-block bg-yellow-100 text-gray-800 text-xs font-semibold px-3 py-1.5 rounded">{{ $product['category'] }}</span>
                                        </div>
                                    @endif
                            ...
                            <div class="mt-auto grid grid-cols-2 gap-3">
                                ...
                                <a href="{{ route('produk.detail', $product['id']) }}"
                                    class="inline-flex items-center justify-center px-3 py-2 border border-red-700 text-red-700 rounded-md hover:bg-red-50 transition text-sm font-medium">
