...
<head>
    ...
    <title>Detail Pembayaran - UlosTa</title>
...
<body class="bg-gray-50 text-gray-800 antialiased">
    ...
    <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 min-h-screen">
        <h1 class="text-3xl font-bold mb-8">Detail Pembayaran</h1>
        ...
        <div class="bg-white rounded-xl shadow-sm p-8 mb-6 text-center">
            ...
            <h2 class="text-xl font-bold mb-2">Pesanan Anda Sedang Diproses</h2>
            <p class="text-gray-600 mb-1">Pesanan #ULS-{{ $order->order_number }} menunggu pembayaran</p>
        </div>
                ...
                <div class="flex gap-4">
                    <div class="w-20 h-20 rounded-lg overflow-hidden bg-gray-100 flex-shrink-0">
                        ...
                        @elseif($item->product && $item->product->image)
                            <img src="{{ asset('image/' . $item->product->image) }}" alt="{{ $item->product->name }}" class="w-full h-full object-cover" />
                        @else
                    ...
                    <div class="flex-1">
                        <h4 class="font-medium">{{ $item->product_name ?? ($item->product->name ?? 'Produk') }}</h4>
        ...
        <div class="space-y-3">
            <a 
                href="{{ route('instruksi.pembayaran', $order->id) }}"
