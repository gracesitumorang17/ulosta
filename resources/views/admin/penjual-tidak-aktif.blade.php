...
<head>
    ...
    <title>UlosTa Admin - Penjual Tidak Aktif</title>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <style>
        :root{--red:#AE0808;--bg:#f8f9fa;--muted:#6c757d;--card:#fff;--border:#e9ecef;--text:#212529;--green:#28a745;--blue:#007bff;--red-light:#dc3545}
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        /* search section */
        .search-section{background:var(--card);border:1px solid var(--border);border-radius:12px;padding:24px;margin-bottom:24px}
        .search-input{display:flex;align-items:center;gap:12px;background:var(--bg);border:1px solid var(--border);border-radius:8px;padding:12px 16px;max-width:400px}
        .search-input input{border:0;outline:none;background:transparent;font-size:14px;flex:1}

        /* table */
        .table-section{background:var(--card);border:1px solid var(--border);border-radius:12px;padding:24px}
        .table-container{overflow-x:auto}
        table{width:100%;border-collapse:collapse}
        thead th{text-align:left;color:var(--text);padding:16px;border-bottom:2px solid var(--border);font-weight:600;font-size:14px}
        tbody td{padding:16px;border-bottom:1px solid var(--border);vertical-align:middle}
        tbody tr:last-child td{border-bottom:none}
        tbody tr:hover{background:#f8f9fa}
        
        .user-cell{display:flex;align-items:center;gap:12px}
        .user-avatar-table{width:40px;height:40px;border-radius:50%;background:#f8f9fa;display:flex;align-items:center;justify-content:center;color:var(--muted);font-weight:600;font-size:14px}
        .user-name{font-weight:500;margin-bottom:2px}
        
        .phone-number{color:var(--muted);font-size:14px}
        .date{color:var(--text);font-size:14px}
        .days-inactive{color:var(--red-light);font-size:14px;font-weight:500}
        
        .action-buttons{display:flex;gap:8px}
        .activate-btn{background:#e3f2fd;color:var(--blue);border:none;padding:6px 12px;border-radius:6px;font-size:12px;font-weight:500;cursor:pointer;transition:all 0.2s}
        .activate-btn:hover{background:#bbdefb}
        .delete-btn{background:#ffebee;color:var(--red-light);border:none;padding:6px 12px;border-radius:6px;font-size:12px;font-weight:500;cursor:pointer;transition:all 0.2s}
    ...
    <div class="layout">
        <aside class="sidebar">
            ...
            <nav class="nav">
                ...
                <div class="nav-item">
                    <a href="{{ route('admin.penjual-tidak-aktif') }}" class="nav-link active">
                        <div class="nav-icon">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <main class="main">
            ...
            <div class="content">
                ...
                <div class="page-header">
                    <h1 class="page-title">Verifikasi Perujuk</h1>
                    <p class="page-desc">Kelola dan verifikasi pengajuan perujuk baru</p>
                </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="user-cell">
                                            <div class="user-avatar-table">N</div>
                                            <div>
                                                <div class="user-name">Nabil cont</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td><a href="mailto:nabi@gmail.com" style="color:#1976d2;text-decoration:none">nabi@gmail.com</a></td>
                                    <td class="phone-number">+62 812-3456-7890</td>
                                    <td class="date">2025-10-03</td>
                                    <td class="days-inactive">46 hari</td>
                                    <td>
                                        <div class="action-buttons">
                                            <button class="activate-btn">Aktifkan</button>
                                ...
                                <tr>
                                    <td>
                                        <div class="user-cell">
                                            <div class="user-avatar-table">S</div>
                                            <div>
                                                <div class="user-name">sayapam</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td><a href="mailto:sayap@gmsil.com" style="color:#1976d2;text-decoration:none">sayap@gmsil.com</a></td>
                                    <td class="phone-number">+62 812-3456-7890</td>
                                    <td class="date">2025-10-03</td>
                                    <td class="days-inactive">55 hari</td>
                                    <td>
                                        <div class="action-buttons">
                                            <button class="activate-btn">Aktifkan</button>
                                            <button class="delete-btn">Hapus</button>
                                ...
                                <tr>
                                    <td>
                                        <div class="user-cell">
                                            <div class="user-avatar-table">A</div>
                                            <div>
                                                <div class="user-name">amos cont</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td><a href="mailto:amos@gmsil.com" style="color:#1976d2;text-decoration:none">amos@gmsil.com</a></td>
                                    <td class="phone-number">+62 812-3456-7890</td>
                                    <td class="date">2025-10-03</td>
                                    <td class="days-inactive">46 hari</td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="user-cell">
                                            <div class="user-avatar-table">B</div>
                                            <div>
                                                <div class="user-name">botak</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td><a href="mailto:botak@gmsil.com" style="color:#1976d2;text-decoration:none">botak@gmsil.com</a></td>
                                    <td class="phone-number">+62 812-3458-7890</td>
                                    <td class="date">2025-10-03</td>
                                    <td class="days-inactive">46 hari</td>
                                    <td>
                                        <div class="action-buttons">
