            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                ...
                <div class="lg:col-span-2 order-2 lg:order-1">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="alamat_lengkap" rows="3" placeholder="Masukkan alamat lengkap" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-red-600"></textarea>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="kode_pos" placeholder="Masukkan Kode Pos" required
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-red-600" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div
                            class="p-4 border border-green-200 bg-green-50 rounded-lg flex items-center justify-between">
                            <div>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <p class="text-sm text-neutral-400">Platform jual beli ulos terpercaya untuk melestarikan
                                tradisi lokal</p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="space-y-2 text-sm">
                                ...
                                <li><a href="#" class="hover:text-white transition">Syarat dan Ketentuan</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="space-y-2 text-sm">
                                ...
                                <li class="flex gap-3 mt-4">
                                    <a href="#" class="text-neutral-400 hover:text-white"><svg class="w-5 h-5"
