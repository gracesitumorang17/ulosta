            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="flex flex-col items-center">
                        <div
                            class="w-32 h-32 rounded-full bg-gradient-to-br from-red-400 to-red-600 flex items-center justify-center text-white text-4xl font-bold mb-4 shadow-lg">
                        ...
                        <span
                            class="inline-block mt-3 bg-red-100 text-red-700 text-xs font-medium px-3 py-1 rounded-full">
                    ...
                    <div class="mt-6 space-y-4 border-t pt-4">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-900">{{ $user->created_at->format('F Y') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 pt-4 border-t">
                        <a href="#"
                            class="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition font-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="flex border-b border-gray-200">
                        ...
                        <button onclick="switchTab('pesanan')" id="tab-pesanan"
                            class="tab-btn flex-1 px-6 py-4 text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
                            Pesanan
                        </button>
                        <button onclick="switchTab('wishlist')" id="tab-wishlist"
                            class="tab-btn flex-1 px-6 py-4 text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
                            Wishlist
                        </button>
                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Nama
                                            Lengkap</label>
                                        <div
                                            class="px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900">
                                            {{ $user->name }}
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <form action="{{ route('profil.update') }}" method="POST">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <textarea id="address" name="address" rows="3" placeholder="Jl.TPL No 123 Balige"
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-300 @error('address') border-red-500 @enderror">{{ old('address', $user->address) }}</textarea>
                                        @error('address')
                                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                    ...
                    <div id="content-pesanan" class="tab-content hidden p-6">
                        ...
                        <div class="flex items-center gap-3 mb-5">
                            <button onclick="switchTab('profil')"
                                class="flex items-center gap-1.5 text-gray-600 hover:text-gray-900 transition text-sm">
                            ...
                            <div class="mb-5 overflow-x-auto">
                                <div class="flex gap-2 border-b">
                                    <a href="{{ route('profil') }}?tab=pesanan&status=all{{ request('search') ? '&search=' . request('search') : '' }}"
                                        ...
                                        <span
                                            class="ml-1.5 px-1.5 py-0.5 text-xs rounded-full">{{ $statusCounts['all'] }}</span>
                                    </a>
                                    <a href="{{ route('profil') }}?tab=pesanan&status=pending{{ request('search') ? '&search=' . request('search') : '' }}"
                                        ...
                                        <span
                                            class="ml-1.5 px-1.5 py-0.5 text-xs rounded-full">{{ $statusCounts['pending'] }}</span>
                                    </a>
                                    <a href="{{ route('profil') }}?tab=pesanan&status=processing{{ request('search') ? '&search=' . request('search') : '' }}"
                                        ...
                                        <span
                                            class="ml-1.5 px-1.5 py-0.5 text-xs rounded-full">{{ $statusCounts['processing'] }}</span>
                                    </a>
                                    <a href="{{ route('profil') }}?tab=pesanan&status=shipped{{ request('search') ? '&search=' . request('search') : '' }}"
                                        ...
                                        <span
                                            class="ml-1.5 px-1.5 py-0.5 text-xs rounded-full">{{ $statusCounts['shipped'] }}</span>
                                    </a>
                                    <a href="{{ route('profil') }}?tab=pesanan&status=delivered{{ request('search') ? '&search=' . request('search') : '' }}"
                                        ...
                                        <span
                                            class="ml-1.5 px-1.5 py-0.5 text-xs rounded-full">{{ $statusCounts['delivered'] }}</span>
                                    </a>
                                    <a href="{{ route('profil') }}?tab=pesanan&status=cancelled{{ request('search') ? '&search=' . request('search') : '' }}"
                                        ...
                                        <span
                                            class="ml-1.5 px-1.5 py-0.5 text-xs rounded-full">{{ $statusCounts['cancelled'] }}</span>
                                    </a>
                                </div>
                            </div>
                                            ...
                                            <tbody class="divide-y divide-gray-200">
                                                @foreach ($orders as $order)
                                                    <tr class="hover:bg-gray-50 transition">
                                                        ...
                                                        <td class="px-4 py-3">
                                                            <p class="text-xs font-bold text-red-600">Rp
                                                        ...
                                                        <td class="px-4 py-3">
                                                            ...
                                                            @endphp
                                                            <span
                                                                class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium {{ $status['color'] }}">
                                                                <span
                                                        ...
                                                        <td class="px-4 py-3">
                                                            <button onclick="showOrderDetail({{ $order->id }})"
                                                                class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                            ...
                            @else
                                <div class="text-center py-12">
                                    ...
                                    <p class="text-gray-600 text-sm mb-1">
                                        {{ request('search') ? 'Tidak ada hasil untuk "' . request('search') . '"' : 'Belum ada pesanan' }}
                                    </p>
                                    <a href="{{ route('homepage') }}"
                                        class="inline-block mt-4 px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition text-sm font-medium">
                                        Mulai Belanja
                                    </a>
                                </div>
                            @endif
                    ...
                    <div id="orderDetailModal"
                        class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-start justify-center p-6"
                        style="padding-top: calc(8rem + 3cm); padding-left: calc(1.5rem + 50px + 4cm);">
